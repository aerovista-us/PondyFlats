/**
 * Lot 2 — R5 schematic floor plans + floor-plan sanity gate
 * Parking geometry is frozen (Lot2R5Freeze). Plans fit inside notched plates only.
 * Program: two enclosed + two covered, independently accessible — not four enclosed.
 */
const Lot2R5Schematic = (() => {
...
if (typeof module !== 'undefined') module.exports = Lot2R5Schematic;

  ...
  function analyze() {
    ...
    return {
      ...
      status: {
        ...
        massingTruth: 'PASS',
        exactPlans: verdict,
        architecturalMassing: verdict === 'PASS' ? 'PASS / FROZEN' : 'WAIT',
        massing: verdict === 'PASS' ? 'PASS — architectural massing frozen' : 'WAIT',
        visualization: 'UNLOCKED on frozen architecture',
      },
